...
randomSketch = quick_draw_data_set[randomNum]
console.log(randomSketch)
document.getElementById("sketchToBeDrawn").innerHTML = "Sketch to be Drawn  is " + randomSketch
}
function setup()
{
...
function results(error , results)
{
    if (error) {
        ...
        console.log(results)
        document.getElementById("yourSketch").innerHTML = "your sketch : " + results[0].yourSketch
        document.getElementById("confidence").innerHTML = "confidence : " + Math.round(reults[0].confidence * 100) + "%"
    }
}